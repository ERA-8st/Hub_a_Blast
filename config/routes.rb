Rails.application.routes.draw do
  ...
  namespace :user do
    ...
    resources :artist_comments, only: [:create, :destrou, :update]
    resources :album_comments, only: [:create, :destrou, :update]
    resources :song_comments, only: [:create, :destrou, :update]
