...
RSpec.describe User::RelationshipsController, type: :controller do
  ...
  describe "create" do
    ...
    #     sign_in user
    #     expect{
    #       post :create , params: { relationship: { follow_id: user2 } }
    #     }.to change(user2.relationships, :count).by(1)
    #   end
    # end
  ...
  describe "destroy" do
    ...
    #     sign_in user
    #     expect{
    #       delete :destroy, params: { id: relationship ,relationship: { follow_id: user2.id } }
    #     }.to change(user2.relationships, :count).by(-1)
    #   end
    # end
    context "ログインしていない場合" do
